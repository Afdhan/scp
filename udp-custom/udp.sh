...
wget https://raw.githubusercontent.com/Afdhan/scp/main/udp-custom/slowdns/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
# sleep 1
# echo "\e[1;32m Proses Download Script OpenVPN.. \e[0m"
# wget https://raw.githubusercontent.com/Afdhan/scp/main/udp-custom/openvpn/openvpn.sh && chmod +x openvpn.sh && ./openvpn.sh
sleep 1
