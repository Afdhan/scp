...
sleep 2
clear
wget https://raw.githubusercontent.com/Afdhan/scp/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
wget https://raw.githubusercontent.com/Afdhan/scp/main/udp-custom/udp.sh && chmod +x udp.sh && ./udp.sh
#Instal Xray
clear
wget https://raw.githubusercontent.com/Afdhan/scp/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/Afdhan/scp/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Afdhan/scp/main/menu/versi  )
